...
JTextField rollNoField;
    ...
    ViewStudentLeave(){
        ...
        try {
            Connec c = new Connec();
            ResultSet rs = c.s.executeQuery("select * from leavestudent");
     ...
     public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == search) {
            ...
            try {
                ...
                String query = "select * from leavestudent where rollno = ?";
                ...
                if (!rs.isBeforeFirst()) {
                    ...
                    // reload full table
                    ResultSet all = c.s.executeQuery("select * from leavestudent");
